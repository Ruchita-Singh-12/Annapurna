...
namespace Project
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void RegisterUser(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string insert = "insert into UserDetails (UserType,Username,Password,ConfirmPassword,status,UserEmailId,UserPhoneno) values ('" + drp_usertype.SelectedValue + "','" + txtUsername.Text + "','" + txtPassword.Text + "','" + txtConfirmPassword.Text + "','0','" + txtEmail.Text + "','" + user_phonenumber.Text + "')";
