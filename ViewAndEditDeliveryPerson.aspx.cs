...
namespace Project
{
    public partial class ViewAndEditDeliveryPerson : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            string query = "select * from UserDetails where UserType='Delivery Person'";
        ...
        protected void OnRowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string name = (row.FindControl("txtdpname") as TextBox).Text;
            string phoneno = (row.FindControl("txtdpphone") as TextBox).Text;
            string address = (row.FindControl("txtdpAddress") as TextBox).Text;
